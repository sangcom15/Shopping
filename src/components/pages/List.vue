    ...
    <main class="main-wrapper" id="container"> 
        ...
        <div class="wrapper">
            ...
            <ul class="small-block-grid-2 medium-block-grid-3 large-block-grid-5 masonry">
                ...
                <figure class="effect-sarah"> <img src="../../assets/images/gallery/01.jpg" alt="NoImage" />
                    <figcaption>
                ...
                <li class="masonry-item grid">
                <figure class="effect-sarah"> <img src="../../assets/images/gallery/20.jpg" alt="" />
                    <figcaption>
                    <h2>Photo <span>Title</span></h2>
                    <p class="description">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
                    <a href="details.html">View more</a> </figcaption>
